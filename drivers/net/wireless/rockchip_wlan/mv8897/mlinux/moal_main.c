...
woal_dump_sdio_reg_info(moal_handle * phandle, t_u8 * drv_buf)
{
	...
	unsigned int reg_table[] = { 0x4C, 0x50, 0x54, 0x55, 0x58, 0x59, 0x5c,
		0x5d
	};
	char buf[128], *ptr;
...
#define DEBUG_DUMP_FIRST_REG		0xE2
#define DEBUG_DUMP_CTRL_REG		0xE3
...
int rockchip_wifi_init_module(void)
{
    ...
    printk("=======================================================\n");
    printk("WiFi driver mv8897(Powered by Rockchip,Ver 1.0) init.\n");
	
	rockchip_wifi_power(1);
	rockchip_wifi_set_carddetect(1);
    return woal_init_module();
}
